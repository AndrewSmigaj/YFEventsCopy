-- Fix Events and Shops Tables v2
-- This script handles foreign key constraints and recreates tables with proper schema
-- Date: 2025-07-05
...
-- Re-add the foreign key from communication_channels to events
ALTER TABLE communication_channels 
ADD CONSTRAINT communication_channels_ibfk_2 
...
-- Add a sample event and shop to test
INSERT INTO events (title, description, start_datetime, location, address, status) VALUES
('Test Event - Homepage Working!', 'This confirms the events table is properly set up', NOW() + INTERVAL 1 DAY, 'Test Location', '123 Test St, Yakima, WA', 'approved');

INSERT INTO local_shops (name, description, address, status) VALUES
('Test Shop', 'This confirms the shops table is working', '456 Shop Ave, Yakima, WA', 'active');
...
SELECT COUNT(*) as shops_count FROM local_shops;