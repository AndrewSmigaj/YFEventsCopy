...
require_once dirname(__DIR__, 2) . '/refactor/vendor/autoload.php';
...
class DatabaseBridge
{
    ...
    {
        $config = require dirname(__DIR__, 2) . '/refactor/config/database.php';
    ...
    public function saveEvent(array $eventData): array
    {
        try {
            ...
            $sql = "INSERT INTO events (
                ...
                status, external_event_id, external_url, created_at, updated_at
        ...
        try {
            $stmt = $this->pdo->query("
                SELECT 
                    ...
                    COUNT(CASE WHEN created_at >= DATE_SUB(NOW(), INTERVAL 7 DAY) THEN 1 END) as recent_events
                FROM events
            ");
